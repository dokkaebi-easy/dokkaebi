...
INSERT INTO `dockerby`.`language`(`language_id`, `language_name`)
VALUES (1, 'Java');
INSERT INTO `dockerby`.`language`(`language_id`, `language_name`)
VALUES (2, 'Python');
INSERT INTO `dockerby`.`language`(`language_id`, `language_name`)
...
INSERT INTO `dockerby`.`build_tool`(`build_tool_name`, `setting_config_id`)
VALUES ('Gradle', 1);
INSERT INTO `dockerby`.`build_tool`(`build_tool_name`, `setting_config_id`)
VALUES ('Maven', 1);
INSERT INTO `dockerby`.`build_tool`(`build_tool_name`, `setting_config_id`)
...
INSERT INTO `dockerby`.`version`(`input_version`, `docker_version`, `language_id`)
